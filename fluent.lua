    ...
    [17] = function()
        ...
        return function(t)
            ...
            v.ContainerHolder =
                ...
                "CanvasGroup",
                {
                    Size = UDim2.new(1, -t.TabWidth - 32, 1, -60),
        ...
        function u.New(v, w, x)
            ...
            local aa, ab =
                ...
                function()
                    ...
                    C.Root.Size = UDim2.fromOffset(930, 530)
                    local D, E, F, G, H, I =
                        z.Hue,
                        z.Sat,
                        z.Vib,
        ...
        function g.New(h, i, j)
            ...
            local w, x = function()
                    ...
                    if ai.ViewportSize.Y - p.AbsolutePosition.Y < v.AbsoluteSize.Y - 5 then
                        w = v.AbsoluteSize.Y - 5 - (ai.ViewportSize.Y - p.AbsolutePosition.Y) - 194
                    end
                    v.Position = UDim2.fromOffset(p.AbsolutePosition.X - 1, p.AbsolutePosition.Y + 30 - w)
                end, 0
            local y, z = function()
